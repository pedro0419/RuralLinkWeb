...
class PostagemController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'preco_kg'    => 'required|numeric|min:0.01|max:999999.99',            
            'quantidade'  => 'required|numeric|min:0.1|max:999999',
            ...
            'preco_kg.max'        => 'O preço não pode ultrapassar R$ 999.999,99.',
            ...
            'quantidade.max'      => 'A quantidade não pode ultrapassar 999.999.',
        ]);

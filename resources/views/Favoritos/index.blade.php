...
<head>
    ...
    <style>
        * { font-family: 'Nunito', sans-serif; box-sizing: border-box; }
        ...
        .product-card { background:white; border-radius:18px; padding:12px; display:flex; gap:12px; align-items:center; border:1.5px solid #f0fdf4; box-shadow:0 2px 8px rgba(0,0,0,0.06); margin-bottom:10px; }
            ...
            <div style="flex:1;min-width:0;">
              ...
              <div style="display:flex;align-items:center;gap:4px;margin-bottom:4px;">
                ...
                @php
                  ...
                  if(strlen($tel)===11) $tel='('.substr($tel,0,2).') '.substr($tel,2,5).'-'.substr($tel,7,4);
                  elseif(strlen($tel)===10) $tel='('.substr($tel,0,2).') '.substr($tel,2,4).'-'.substr($tel,6,4);
                  else $tel=$postagem->user->phone??'-';
                @endphp
